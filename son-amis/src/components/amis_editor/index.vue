...
export default {
  ...
  methods: {
    onSave( flag = false ) {
      const loading = this.$loading("保存")
      api.post('/menu/edit', { menu_id: this.menu_id, json: JSON.stringify(this.amis.value) }).then(res => {
    ...
    init(row) {
      api.get('/menu/info', { menu_id: row.menu_id || undefined, path: row.path || undefined }).then(res => {
...
<style scoped>
  ...
  .Editor-view-mode-group-container .Editor-view-mode-group{
    font-size: 14px;
  ...
  .Editor-view-mode-group-container .Editor-view-mode-group .Editor-view-mode-btn{
    user-select: none;
    padding: 0;
    border-radius: 4px;
    width: 40px;
  ...
  .Editor-view-mode-group-container .Editor-view-mode-group .Editor-view-mode-btn:hover {
    background-color: #f2f2f4;
  }
  .Editor-view-mode-group-container .Editor-view-mode-group .Editor-view-mode-btn svg{
    color: #151b26;
  }
  .Editor-view-mode-group-container .Editor-view-mode-group .Editor-view-mode-btn:first-child {
    margin-right: 12px;
  }
  .Editor-view-mode-group-container .Editor-view-mode-group .Editor-view-mode-btn:hover > svg{
    color: #2468f2;
  }
  .Editor-view-mode-group-container .Editor-view-mode-group .Editor-view-mode-btn.is-active{
    background: #2468f2;
    color: #ffffff;
  }
  .Editor-view-mode-group-container .Editor-view-mode-group .Editor-view-mode-btn.is-active svg{
    color: #fff;
  }
  .Editor-view-mode-group-container .Editor-view-mode-group .Editor-view-mode-btn.is-active :hover {
    background: #5086f5;
  }
